const projects = [
  ...
  problem: [
  "Finding information across multiple PDFs and presentations can be slow and difficult.",
  "Traditional keyword search often misses context and relationships between topics.",
  "Users need a system that can answer questions, summarize content, and compare multiple documents.",
  "The goal was to build a privacy-focused AI assistant that runs locally without external APIs."
],

approach: [
  "Built a Retrieval-Augmented Generation (RAG) pipeline using LangChain and local LLMs.",
  "Processed PDF and PowerPoint documents by extracting text and metadata.",
  "Generated embeddings and stored them in ChromaDB for semantic search.",
  "Implemented multiple retrieval methods including BM25, Dense Retrieval, Hybrid Retrieval, and Reranking.",
  "Integrated Ollama-hosted Llama and Mistral models to generate document-grounded responses."
],

architecture: [
  "Streamlit interface handles document upload, chat interaction, and summarization.",
  "Documents are processed, chunked, and converted into embeddings.",
  "ChromaDB stores vector embeddings and document metadata for retrieval.",
  "Retrieval pipelines fetch the most relevant content before response generation.",
  "Local LLMs generate answers, summaries, and document comparisons."
],

challenges: [
  "Improving retrieval accuracy across different document types.",
  "Preserving source information while processing and chunking documents.",
  "Reducing hallucinations by grounding responses in retrieved content.",
  "Evaluating retrieval and answer quality using multiple metrics."
],
  impact:
